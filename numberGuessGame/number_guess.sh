...
then
  ...
  GET_USER_GAMES_DATA="$($PSQL "SELECT COUNT(*), MIN(score) FROM games WHERE user_id = $USER_ID;")"
...
#insert game data
INSERT_NEW_GAME="$($PSQL "INSERT INTO games(user_id, score) VALUES($USER_ID, '$NUMBER_OF_GUESSES');")"
